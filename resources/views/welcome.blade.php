...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="mt-60">
            <h2 class="font-serif text-6xl font-semibold text-black pt-10 text-center">Mari Donasi</h2>
        </div>

        <div>
            <p class="font-serif text-4xl text-center mt-7">
                Jangan lupa untuk berbagi sesama saudaramu
            </p>
        </div>
        ...
        <div class="flex items-center justify-center mt-10 mr-13 ml-13">
            @if (Route::has('login'))
                <div class="sm:center-0 p-6 text-center ">
                    @auth
